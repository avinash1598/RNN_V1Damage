...
tuningParams.d = zeros(1, nNeurons) + 1;       % Was set to 1! Is this problamatic? (fixed) Direction selectivity - set it to zero (no need for neuron to be directional selective).
