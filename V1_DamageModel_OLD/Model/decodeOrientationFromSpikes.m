...
function [thetaMLE, pdfData] = decodeOrientationFromSpikes(spikes, neuronsPrefOrientation, params, tuningParams)
    ...
    [~, idx_max] = max(log_pdf);  % Index of the orientation that maximizes log_pdf
    ...
    % This is wrong - mean is circular here
    % But this is fine as long as angle is not near zero or 180 degrees
    %warning("This is wrong - mean is circular here.")
    mu    = sum( x_deg.*pdf*dx );
