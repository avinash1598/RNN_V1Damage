...
% ---------------------------------------------------------------------
function [contrastMLE, spreadMLE, thetaMLE, pdfData, MLEs, metrics] = decodePoissonSpikes(spikes, tuningFns, params)
    ...
    % This probably needs to be made even more finer
    ...
    % Note: these PDFs do not integrate to 1 using trapz rule
